...
class TestGod < Test::Unit::TestCase
  ...
  def test_status_should_show_state
    ...
    w = God.watches['foo']
    w.state = :up
    assert_equal({'foo' => {:state => :up, :group => nil, :pid => nil}}, God.status)
  end
  ...
  def test_status_should_show_state_with_group
    ...
    w = God.watches['foo']
    w.state = :up
    assert_equal({'foo' => {:state => :up, :group => 'g', :pid => nil}}, God.status)
  end
  ...
  def test_status_should_show_unmonitored_for_nil_state
    ...
    w = God.watches['foo']
    assert_equal({'foo' => {:state => :unmonitored, :group => nil, :pid => nil}}, God.status)
  end
